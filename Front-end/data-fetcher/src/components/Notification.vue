<script>
  ...
  export default {
    ...
    methods : {
      ...
      /**
       * Returns text to be appended when status is successful.
       * 
       */
      successfulText() {
      ...
      /**
      * Returns text to be appended when status is updating.
      * 
      */
      updatingText() {
      ...
      /**
      * Returns text to be appended when status is error.
      * 
      */
      errorText() {
