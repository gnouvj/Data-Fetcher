...
export default {
    ...
    watch: {
        /**
         * Watch file type. If it changes, update the pop-up form by pulling data from back-end.
         * 
         * @param newFileType new chosen file type
         * @param oldFileType old file type (discarded)
         */
    ...
    methods : {
        /**
         * Send current data to back-end as JSON and go back to homepage
         */
        sendData() {
        ...
        /**
         * Capitalize the string to look better when displaying.
         * 
         * @param {string} string 
         */
        converter(string) {
